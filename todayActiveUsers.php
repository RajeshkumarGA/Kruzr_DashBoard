<?php
	...
	if($server){
		...
		$sql_query_user_details = "SELECT * FROM userdetails WHERE createdDate  between '$last6_date' and '$current_date' and iduserDetails IN(SELECT userid FROM activeusers)";
