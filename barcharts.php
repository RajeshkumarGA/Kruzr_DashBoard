<?php
	...
	if($server){
		$sql_query_user_details = "SELECT Month(createdDate) AS forMonth, COUNT(*) AS downloadsCount FROM $database.userDetails where YEAR(createdDate) = '2017' GROUP BY MONTH(createdDate)";
