<?php
	...
	if($server)
	{
		// $sql_query_user_details = "SELECT * FROM $database.userDetails WHERE createdDate between '$last6_date' and '$current_date'";
		$sql_query_user_details = "SELECT * FROM $database.userDetails WHERE createdDate  between '$last6_date' and '$current_date' and iduserDetails IN(SELECT DISTINCT uid FROM $database.TripDetails)";
	...
	{
			// $sql_query_user_details = "SELECT DISTINCT uid FROM tripdetails";
		$sql_query_user_details = "SELECT * FROM userdetails WHERE createdDate  between '$last6_date' and '$current_date' and iduserDetails IN(SELECT DISTINCT uid FROM tripdetails)";
